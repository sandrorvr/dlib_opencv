...
#ESTA FUNÇÃO USA A TECNICA HAARCASCADE
    ...
    def detector(self):
        ...
        detectorPontos = dlib.shape_predictor("/home/pi/Documents/face-python/script_dlib/shape_predictor_68_face_landmarks.dat")
        reconhecimentoFacial = dlib.face_recognition_model_v1("/home/pi/Documents/face-python/script_dlib/dlib_face_recognition_resnet_model_v1.dat")
        indices = np.load("/home/pi/Documents/face-python/script_dlib/indices_rn.pickle")
        descritoresFaciais = np.load("/home/pi/Documents/face-python/script_dlib/descritores_rn.npy")
        limiar = 0.5
        classificador_face = cv2.CascadeClassifier('/home/pi/Documents/face-python/script_dlib/face.xml')
        while not self.stopped:
...
#ESTA FUNCAO USA A TECNICA HOG
    ...
    def show(self):
        classificador_olho = cv2.CascadeClassifier('/home/pi/Documents/face-python/script_dlib/olho.xml')
        while not self.stopped:
            #print(self.fila)
            '''try:
